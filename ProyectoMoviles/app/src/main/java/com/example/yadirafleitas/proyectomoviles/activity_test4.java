 ...
 */
public class activity_test4 extends AppCompatActivity{
    Bundle bundle;
    Button boton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton = (Button)findViewById(R.id.boton1Test4);
...
//Para segunda pregunta
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(activity_test4.this, activity_test5.class);
