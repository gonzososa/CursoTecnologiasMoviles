 ...
 */
public class activity_test6 extends AppCompatActivity{
    Bundle bundle;
    Button boton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        boton = (Button)findViewById(R.id.boton1Test6);
...
//Para segunda pregunta
        ...
        boton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(activity_test6.this, activity_info_personal.class);
